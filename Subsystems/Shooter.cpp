...
Shooter::Shooter() : Subsystem("Shooter") {
	...
	1BitIREncoder = RobotMap::shooter1BitIREncoder;
...
void Shooter::InitDefaultCommand() {
	...
	printf ("This is the LATEST  most build\n");
...
void Shooter::ReportSpeed()
{
	...
	float supportShooterVoltage = supportShooter->GetOutputVoltage();
	...
	SmartDashboard::PutNumber("shooter speed", (double)WilliesSpeed);
	SmartDashboard::PutNumber("angleing speed", (double)WilliesSpeed3);
	SmartDashboard::PutNumber("main shooter voltage", (double)mainShooterVoltage);
	SmartDashboard::PutNumber("support shooter voltage", (double)supportShooterVoltage);

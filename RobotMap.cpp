...
SpeedController* RobotMap::climberCheckSpeedController1 = NULL;
SpeedController* RobotMap::climberCheckSpeedController2 = NULL;
CANJaguar* RobotMap::climberCheckLeftCIM = NULL;
CANJaguar* RobotMap::climberCheckRightCIM = NULL;
...
void RobotMap::init() {
	...
	climberCheckSpeedController1 = new Victor(1, 1);
	lw->AddActuator("ClimberCheck", "Speed Controller 1", (Victor*) climberCheckSpeedController1);
	
	climberCheckSpeedController2 = new Victor(1, 2);
	lw->AddActuator("ClimberCheck", "Speed Controller 2", (Victor*) climberCheckSpeedController2);
	
	climberCheckLeftCIM = new CANJaguar(2);
	
	
	climberCheckRightCIM = new CANJaguar(3);
